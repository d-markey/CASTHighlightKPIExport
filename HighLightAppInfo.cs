...
namespace HighlightKPIExport {
    ...
    public class HighlightMetric {
        ...
        public void AppendSymbols(Dictionary<string, string> symbols, string prefix = "") {
            ...
            var zero = prefix.Contains("Trend") ? ";'-'" : "";
            ...
            symbols.Add(prefix + "Roadblocks",              Roadblocks.ToString(sign + "###0;'-'###0" + zero));
            symbols.Add(prefix + "TotalLinesOfCode",        TotalLinesOfCode.ToString(sign + "###0;'-'###0" + zero));
            symbols.Add(prefix + "TotalFiles",              TotalFiles.ToString(sign + "###0;'-'###0" + zero));
            ...
            symbols.Add(prefix + "TechnicalDebt",           TechnicalDebt.ToString(sign + "###0;'-'###0" + zero));
