...
Pour obtenir de l'aide :
	...
	Available options:
		--url [value]: base URL of CAST Highlight server; default is https://rpa.casthighlight.com
		...
		--template [value], -t [value]: file name of the template file; by default, "template_scorecard.txt" for a single application, "template_csv.txt" for multiple applications
